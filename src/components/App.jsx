...
function Home() {
  ...
  console.log("my info", countryInfo);
  ...
  const sortData = async () => {
    ...
    if (button === true) {
      await setTabledata(decData);
    } else await setTabledata(sortedData);
  };
    ...
    <ThemeContext.Provider value={theme}>
      <div>
        <div className="header">
          <h1>
            C
            <span className="virus" style={{ transform: "rotate(10)" }}>
              <FontAwesomeIcon icon={faVirus}></FontAwesomeIcon>
            </span>
            VID 19
          </h1>
        </div>
        <div className="app" style={theme ? lightThemeApp : darkThemeApp}>
          ...
          <div className="app__left">
              ...
              <FormControl className="app__dropdown">
                ...
                >
                  ...
                  {countries.map((country) => {
                    return (
                      <MenuItem className="dropdown" value={country.name}>
                        {country.name}
                      </MenuItem>
                    );
                  })}
            ...
            <div className="app__stats">
              ...
              <InfoBox
                ...
                className={clicked ? "isGreen" : null}
                title="Recovered"
          ...
          <div className="right_div">
            <Card className="app__right">
              <CardContent>
                ...
                <i class="fas fa-angle-double-down" onClick={sortData}></i>
